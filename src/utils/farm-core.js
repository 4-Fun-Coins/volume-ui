...
import {getAverageBlockTime} from "./volume-core";

const {volumeAddress, rpcUrl, volumeJackpotAddress, volumeFaucet, chainId, farmAddress} = require('./DeploymentConfig.js');
const Web3 = require('web3');
const Big = require('big.js');
const {erc20ABI} = require('../utils/erc20-abi');
//const FarmContact = new web3.eth.Contract(FarmABI, farm);
...
export const getRewardToken = async (farmContract) => {
    return await farmContract.methods.bep20();
}
